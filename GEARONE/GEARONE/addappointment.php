...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="mycalendar.php"><em class="fa fa-calendar">&nbsp;</em><b> My Calendar</b></a></li>
			<li class="active"><a href="addappointment.php"><em class="fa fa-plus-circle">&nbsp;</em><b> Create Appointment</b></a></li>
